...
```
process <- tibble::tribble(~Owner, ~Task, ~Timeframe, 
"Homeowner",
...
"ARC",
"Review the ARC Request Form against the guidelines and best practices. If the ARC request conforms to the guidelines, send approval of form to the homeowner and the Management Company.\nIf the Request does not conform to the guidelines, send a formal denial to the homeowner and the Management Company with reasons for denial.",
...
"Complete within one year of approval date (4).\nBefore initiating construction\nWithin 10 days of denial date",
