---
title: "Court Order in the case of the Glenlake annexation issue"
output: pdf_document
header-includes: |
    \usepackage{censor} 
    \usepackage{fancyhdr} 
    ...
    \fancyfoot{}
    \fancyhead{}
    \fancyfoot[L]{Court Order in the case of the Glenlake annexation issue} 
...
> Document version `r format(lubridate::today(), format="%b %d, %Y")`
