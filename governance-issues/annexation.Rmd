...
* Print a copy of the Consent Form if you receive it in digital format, otherwise use the Form you receive by regular mail;
* Locate a Notary and, if necessary, make an appointment;
* Take any other co-owner(s) with you to the meeting with the Notary;
* Clearly print the names of all owner(s) above the signature line(s) on the Consent Form;
* Have all owners sign the Form, the Witnesses sign the Form, and the Notary sign and affix his or her seal;
* Return the Consent Form to Hinson Management’s Office in person or via USPS Mail.
