...
+--------------------------------------+-----------------------+
| Supercedes Issue No: none \          | Issue No:Original\    |
| Date: None                           | Date: July 22nd, 2019 |
+--------------------------------------+-----------------------+
...
In case members cannot be physically present at an Association meeting, they can assign a proxy to another person[@by0313] by sending a proxy form to the Secretary of the Board of Directors. Proxies can be assigned to any other member of the Association in good standing. The proxy must be specific in the duration of the assignment and the powers transferred. Examples of both can be found in the table.
...
This serves as the official opening of the meeting. This indicates that only Board Directors can request to speak, unless others expressly allowed to do so by the meeting chair[@by0313].
