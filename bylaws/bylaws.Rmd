...
> Disclaimer: this document is a transcription of the original Bylaws, registered at the Spartanburg Register of Deeds in deed book 82R, page 914, and serves only to provide a searchable form of the Bylaws. This document cannot be used to claim legal standing. This document has been compiled from the original Bylaws and the Amendment. The editors of this version believe this is the most recent version of the declaration as of `r format(lubridate::today(), format="%B %d, %Y")`.
...
## 5.2 Town home Committee.^[this article is part of the Second Amendment to the Bylaws - Ed.]
