...
During the first elections after the developer handover in 2018, seven Directors were elected in accordance with the Bylaws,[@by0303] four of those with a term of two years and three with a term of one year. Because of the staggering of terms, during the odd years (*e.g.* `r yearstext("odd")`), three positions are available and during the even years (*e.g.* `r yearstext("even")`), four positions are available. Due to the Bylaws, one position on the Board of Directors must be filled by a representative of the Town Home owners.[@by0305c]
...
*Good standing* is defined as having paid all annual assessments and fines.[@cov0511c]^,^[@by0306] *Owner of a home* is defined as being listed on the deed or be the spouse of the person listed on the deed.[@by0301]^,^[@cov0402]^,^[@cov01owner]
