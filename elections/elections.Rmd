...
During the first elections after the developer handover in 2018, seven Directors were elected in accordance with the Bylaws,[@by0303] four of those with a term of two years and three with a term of one year. Because of the staggering of terms, during the odd years (*e.g.* `r yearstext("odd")`), three positions are available and during the even years (*e.g.* `r yearstext("even")`), four positions are available. In accordance with the Bylaws, one position on the Board of Directors must be filled by a representative of the Town Home owners.[@by0305c]
